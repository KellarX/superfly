...
bot.on("message", async message => {
    ...
    if(cmd === `${prefix}sfinfo`){
        ...
        .setTitle("Köszöntelek a Superfly Discord szerverén!")
        .addField("Youtube link:", "https://www.youtube.com/channel/UCWeHooRc-YwY-3nxQCOgvQg\n Discord: \nhttps://discord.gg/6GNGFmWTAx\n Weboldal link: http://superfly.gtk.hu/ ")
    ...
    if(cmd === `${prefix}help`){
        ...
        .setAuthor(message.author.username)
        .setTitle("Parancsok:")
        .addField("!hello - szia\n!sfinfo - SF Információk\n!help - Parancsok\n!szöveg - Szöveg kiírása (Adminisztrátor)\n!kick - Kirúgás (Adminisztrátor)\nban - Kitiltás (Adminisztrátor)\nweather - Egy város időjárásának lenézése\n")
        .setThumbnail(message.author.displayAvatarURL())
        .setImage(message.guild.iconURL())
        .setDescription(`\`${prefix}\``)
        .setFooter(`${botname} | ${message.createdAt}`)
